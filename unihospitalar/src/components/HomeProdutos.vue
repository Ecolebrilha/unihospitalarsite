<template>
  <div class="produtos">
    ...
    <div class="banner-container">
      ...
      <img src="@/assets/header-produtos.jpg" alt="Imagem do Banner">
    </div>
    ...
    <main>
      <section class="produtos-content">
        ...
        <div class="card">
          ...
          <h2>MEDICAMENTOS PARA ONCOLOGIA</h2>
    ...
    <a href="https://ecolebrilha.github.io/unihospitalarsite/unihospitalar/@/assets/uni-hospitalar-produtos.pdf">
